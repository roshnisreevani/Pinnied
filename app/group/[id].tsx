...
import { Calendar, Check, ChevronLeft, ImagePlus, Lock, MessagesSquare, Scale, Swords, Trophy, UserPlus, Users2, X } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.flex} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.actionRow}>
          ...
          <AnimatedPressable
            style={[styles.banterButton, styles.actionButton]}
            onPress={() => router.push(`/group/pickem/${group.id}`)}>
            <Scale size={16} color={colors.text} strokeWidth={2} />
            <Text style={styles.banterButtonText}>Pick&rsquo;Em</Text>
          </AnimatedPressable>
        </View>
          ...
          {posts.length === 0 ? (
            ...
            posts.map((post) => (
              <PostCard
                ...
                onOpenPost={() =>
                  post.highlightClipId
                    ? router.push(`/highlight/${post.highlightClipId}?readonly=1`)
